...
if [ ! -n "$WERCKER_IRC_NOTIFY_NICKSERV" ]; then
  export WERCKER_IRC_NOTIFY_NICKSERV="none"
fi


python "$WERCKER_STEP_ROOT/main.py" "$WERCKER_IRC_NOTIFY_SERVER" "$WERCKER_IRC_NOTIFY_PORT" "$WERCKER_IRC_NOTIFY_NICKNAME" "$WERCKER_IRC_NOTIFY_CHANNEL" "$WERCKER_IRC_NOTIFY_MESSAGE" "$WERCKER_IRC_NOTIFY_DOUBLEHASHES" "$WERCKER_IRC_NOTIFY_NICKSERV"
